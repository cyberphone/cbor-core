...
class CBOR:
    ...
    class CborObject:
        ...
        # Private methods
        def _conditionally_mark_as_read(self, object):
    ...
    class Map(CborObject):
        ...
        def get(self, key):
            ...
            for i in self.entries:
                if i.key == key:
                    return self._conditionally_mark_as_read(i.value)
    ...
    class Array(CborObject):
        ...
        def get(self, index):
            return self._conditionally_mark_as_read(self.elements[CBOR._is_int(index)])
    ...
    class Tag(CborObject):
        ...
        def get(self):
            return self._conditionally_mark_as_read(self.object)
